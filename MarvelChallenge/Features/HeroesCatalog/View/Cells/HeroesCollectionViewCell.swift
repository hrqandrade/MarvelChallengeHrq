...
final class HeroesCollectionViewCell: UICollectionViewCell {
    static let reuseIdentifier = String(describing: HeroesCollectionViewCell.self)
    ...
    override func prepareForReuse() {
        ...
        heroImageView.cancelImageLoad(); heroImageView.image = nil; nameLabel.text = nil
    ...
    private func configureView() {
        ...
        let footer = UIStackView(arrangedSubviews: [nameLabel, favoriteButton])
        footer.alignment = .center; footer.spacing = DesignSystem.Spacing.small
        let stack = UIStackView(arrangedSubviews: [heroImageView, footer])
        stack.translatesAutoresizingMaskIntoConstraints = false; stack.axis = .vertical; stack.spacing = DesignSystem.Spacing.small
